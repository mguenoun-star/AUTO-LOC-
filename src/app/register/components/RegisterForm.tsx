...
export default function RegisterForm() {
  ...
  if (isSuccess) {
    return (
      <div className={`w-full lg:w-[55%] ${current.bg} ${current.text} flex flex-col items-center justify-center p-6 md:p-12 lg:p-20 text-center`}>
        <motion.div
        ...
        >
          ...
          <Link
            href="/login"
            className={`inline-block w-full py-4 px-6 rounded-lg font-bold text-white transition-all ${current.btn} hover:scale-105`}
          >
            Go to Login
          </Link>
        </motion.div>
